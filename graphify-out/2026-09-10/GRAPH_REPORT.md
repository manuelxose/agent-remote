...
## Corpus Check
- 56 files · ~22,120 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 469 nodes · 670 edges · 38 communities (23 shown, 9 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ec22fb03`
...
Cohesion: 0.10
Nodes (19): Worker, AgentResponse, AgentRuntime, ConversationAgent, ConversationContext, DomainEvent, DomainEventType, EventBus (+11 more)
...
## Knowledge Gaps
- **152 isolated node(s):** `defaultLogger`, `RawMessageKey`, `RawWhatsAppMessage`, `attachmentKinds`, `Resolver` (+147 more)
