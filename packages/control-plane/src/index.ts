...
export class ControlPlane {
  ...
  private registerCommands(): void {
    ...
    add("importar", "Import a WhatsApp conversation into searchable chat history.", "/importar [name] (or /import)", "SESSION", async () => ({ text: "Use /importar <name> to import a WhatsApp conversation directly. A .txt export can also be attached when the conversation is not available to the linked device.", status: "warning" }), { aliases: ["import"], requiresInitialization: false, requiredRole: "operator" });
