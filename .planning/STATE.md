...
- History pagination correction: Baileys on-demand history requests are capped at 50 messages per page; `/import <name> más` and `/import <name> completo` now use that limit, and empty or timed-out pages never claim that the archive is exhausted. Final verification on 2026-09-14: `npm test` reports 222 tests, 220 passed, 0 failed, 2 skipped.
